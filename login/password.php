							...
							<form method="post" id="changepassForm" onSubmit="return false;">
								...
								<div class="card">
									<div class="card-header">
										<h5 class="card-title m-0"><i class="fa fa-fw fa-lock"></i> Update Password</h5>
									</div>
									<div class="card-body">
										...
										<div class="form-group">
											<div class="row">
												<div class="col">
													<a href="index.php" class="btn btn-block btn-secondary"><i class="fa fa-long-arrow-alt-left"></i> Sign In</a>
												</div>
												<div class="col">
													<button type="submit" name="changePassSubmit" id="changePassSubmit" class="btn btn-block btn-primary" onClick="return formValidate('#changepassForm','#changePassMsg');"><i class="fa fa-edit"></i> Update</button>
												</div>											
											</div>
										</div>
									</div>
